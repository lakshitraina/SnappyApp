...
public class LoginActivity extends AppCompatActivity {
    ...
    ProgressBar progressBar; // ProgressBar for sign-in loading
    KProgressHUD progressHUD; // KProgressHUD for loading spinner
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize KProgressHUD for a better loading experience
    ...
    void signInWithGoogle() {
        // Show loading indicators when sign-in starts
        progressHUD.show();
