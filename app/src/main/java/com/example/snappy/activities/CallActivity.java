...
import com.example.snappy.databinding.ActivityCallBinding;
import com.example.snappy.models.InterfaceJava;
...
public class CallActivity extends AppCompatActivity {
    ...
    void endCall() {
        ...
        // Stop the WebView and clean up any ongoing calls or processes
        callJavaScriptFunction("javascript:endCall()");

        // Remove data from Firebase and clean up other resources
